...
<body class="bg-gray-100 text-gray-900" x-data="{ isOpen: false, detailModal: false, draftModal: false, currentItem: null }">
    <!-- Sidebar -->
                ...
                <div class="overflow-y-auto h-[500px] pr-2 scrollbar-hide">
                    <div class="mt-4 grid grid-cols-2 gap-4">
                        <?php foreach ($data as $row): ?>
                            ...
                            <div @click="detailModal = true; currentItem = {
                                ...
                                class="p-4 rounded-lg h-[140px] relative shadow" style="background-color: #EEFFE5;">
                                <!-- เสร็จสิ้น badge -->
                            ...
                            class="p-4 rounded-lg h-[140px] relative shadow" style="background-color: #FFF3F3;">
                                <!-- เสร็จสิ้น badge -->
                ...
                <div class="overflow-y-auto h-[500px] pr-2 scrollbar-hide">
                    <div class="mt-4 grid grid-cols-2 gap-4">
                        <?php foreach ($data as $row): ?>
                            ...
                            class="p-4 bg-white rounded-lg h-[105px] relative shadow">
                        ...
                        <div
                         ...
                         class="mt-4 grid grid-cols-3 gap-4">
                            ...
                            <?php if (in_array($row['work_status'], ['C', 'D'])): ?>
                                ...
                                class="p-4 rounded-lg <?= $row['work_status'] === 'C' ? 'bg-green-100' : 'bg-red-100' ?>">
                ...
                <form action="{{ url('/work_request') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 mb-4">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <input type="text" name="work_name" id="work_name"
                                class="border px-3 py-2 rounded w-full" placeholder="กรุณากรอกชื่อเรื่อง" x-model="currentItem.name" required>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-900 font-semibold" x-text="currentItem.userId">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <label class="flex items-center space-x-1">
                                    <input type="radio" name="work_author_type" value="D"   class="accent-blue-600" <?= $row['work_author_type'] === 'D' ? 'checked' : '' ?>>
                                    <span class="text-gray-700 text-sm">ระบุ</span>
                                </label>
                                <label class="flex items-center space-x-1">
                                    <input type="radio" name="work_author_type" value="P"  class="accent-blue-600" <?= $row['work_author_type'] === 'P' ? 'checked' : '' ?>>
